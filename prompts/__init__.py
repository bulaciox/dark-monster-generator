"""All the wording sent to the LLM/image models for the individual-monster
pipeline (curator.extract_identity, curator.build_story_and_title,
generator.generate_organ, generator.generate_silhouette), split one concern
per file so they are easy to find and edit without touching the orchestration
code in curator.py/generator.py:

  system.py      - the shared LLM system prompt (voice, privacy rules, how to
